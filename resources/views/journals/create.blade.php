...
<head>
    ...
    <title>Add New Journal - SantriKoding.com</title>
                    ...
                    <div class="card-body">
                        <form action="{{ route('journals.store') }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control @error('abstract') is-invalid @enderror" name="abstract" rows="5" placeholder="Enter Abstract">{{ old('abstract') }}</textarea>
