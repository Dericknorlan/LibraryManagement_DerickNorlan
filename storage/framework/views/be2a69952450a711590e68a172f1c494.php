...
unset($__errorArgs, $__bag); ?>" name="title"
                                    value="<?php echo e(old('title', $newspaper->title)); ?>" placeholder="Enter Newspaper Title">
...
unset($__errorArgs, $__bag); ?>" name="publisher"
                                    value="<?php echo e(old('publisher', $newspaper->publisher)); ?>" placeholder="Enter Publisher's Name">
...
unset($__errorArgs, $__bag); ?>" name="publication_date"
                                    value="<?php echo e(old('publication_date', $newspaper->publication_date)); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input <?php $__errorArgs = ['is_available'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="is_available" value="1"
                                        <?php echo e(old('is_available', $newspaper->is_available) ? 'checked' : ''); ?>>
...
<?php /**PATH D:\xampp\htdocs\LibraryManagement_DerickNorlan\LibraryManagement\resources\views/newspapers/edit.blade.php ENDPATH**/ ?>