        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <a href="<?php echo e(route('journals.create')); ?>" class="btn btn-md btn-success mb-3">ADD JOURNAL</a>
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo e($journal->author); ?></td>
                                    <td><?php echo e($journal->publish_date); ?></td>
                                    <td><?php echo e(Str::limit($journal->abstract, 50)); ?></td>
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo e(route('journals.show', $journal->id)); ?>" class="btn btn-sm btn-dark">SHOW</a>
                                        <a href="<?php echo e(route('journals.edit', $journal->id)); ?>" class="btn btn-sm btn-primary">EDIT</a>
                                        <button onclick="confirmDelete(<?php echo e($journal->id); ?>)" class="btn btn-sm btn-danger">DELETE</button>
                                    </td>
                                </tr>
...
</html><?php /**PATH D:\xampp\htdocs\LibraryManagement_DerickNorlan\LibraryManagement\resources\views/journals/index.blade.php ENDPATH**/ ?>