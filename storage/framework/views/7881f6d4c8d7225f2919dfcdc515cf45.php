        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded mt-3">
                    <div class="card-body">
                        <form action="<?php echo e(route('cds.update', $cd->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="title"
                                    value="<?php echo e(old('title', $cd->title)); ?>" placeholder="Enter CD Title">
...
unset($__errorArgs, $__bag); ?>" name="artist"
                                    value="<?php echo e(old('artist', $cd->artist)); ?>" placeholder="Enter Artist's Name">
...
unset($__errorArgs, $__bag); ?>" name="genre"
                                    value="<?php echo e(old('genre', $cd->genre)); ?>" placeholder="Enter CD Genre">
...
unset($__errorArgs, $__bag); ?>" name="stock"
                                    value="<?php echo e(old('stock', $cd->stock)); ?>" placeholder="Enter Stock Quantity">
...
<?php /**PATH D:\xampp\htdocs\LibraryManagement_DerickNorlan\LibraryManagement\resources\views/cds/edit.blade.php ENDPATH**/ ?>