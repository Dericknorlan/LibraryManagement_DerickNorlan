        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card border-0 shadow-sm rounded mt-3">
                    <div class="card-body">
                        <form action="<?php echo e(route('journals.update', $journal->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="title"
                                    value="<?php echo e(old('title', $journal->title)); ?>" placeholder="Enter Journal Title">
...
unset($__errorArgs, $__bag); ?>" name="author"
                                    value="<?php echo e(old('author', $journal->author)); ?>" placeholder="Enter Author's Name">
...
unset($__errorArgs, $__bag); ?>" name="publish_date"
                                    value="<?php echo e(old('publish_date', $journal->publish_date)); ?>">
...
unset($__errorArgs, $__bag); ?>" name="abstract" rows="5"
                                    placeholder="Enter Journal Abstract"><?php echo e(old('abstract', $journal->abstract)); ?></textarea>
...
<?php /**PATH D:\xampp\htdocs\LibraryManagement_DerickNorlan\LibraryManagement\resources\views/journals/edit.blade.php ENDPATH**/ ?>